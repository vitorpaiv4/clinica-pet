      ...
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
        ...
        <motion.div className="space-y-4" initial="hidden" animate="visible" variants={staggerContainer}>
          ...
          <motion.p className="text-[#5e6472]" variants={fadeIn}>
            A PetLife é o seu refúgio de confiança para cuidar do bem-estar do seu pet. Com profissionais dedicados
            e serviços abrangentes, oferecemos uma experiência acolhedora e personalizada garantindo o bem-estar, a
            saúde e a felicidade dos seus animais de estimação.
          </motion.p>
