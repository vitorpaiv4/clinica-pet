...
export function VeterinaryCare() {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            <motion.p className="text-[#5e6472]" variants={fadeIn}>
              ...
              comprometidos, oferecemos serviços de saúde e bem-estar para animais de estimação de todas as
              espécies. Venha conhecer nossas clínicas e desfrute da atenção personalizada e do carinho que seu pet
              merece.
            </motion.p>
